...
# -*- coding: utf-8 -*-
"""
Pipeline EQUATORIAL AP BT: OCR -> Digitacao -> Filtro.

Uso:
    python pipeline_equatorial_ap_bt.py --mes 06 --ano 2026 --pasta "//servidor/..."
"""
...
OCR_SCRIPT = LOCAL_DIR / "ocr" / "ocr_equatorial_ap_bt.py"
...
OCR_SAIDA_DIR = SERVIDOR / "ARQUIVOS ENZO" / "OCR EQUATORIAL AP"
PIPELINE_SAIDA = SERVIDOR / "ARQUIVOS ENZO" / "EQUATORIAL_AP_pipeline_saida"
DIGITADAS_DIR = Path("//10.10.250.21/Energia/CONTASDEENERGIAELETRICA/BB/ENZO/Digitadas")
PIPELINE_NOME = "EQUATORIAL AP BT"
...
def _xlsx_saida(mes: str, ano: str) -> Path:
    return OCR_SAIDA_DIR / f"ocr_equatorial_ap_BT_{mes}{ano}.xlsx"


def _xlsx_resgate(slug: str) -> Path:
    return OCR_SAIDA_DIR / "_resgates" / f"ocr_equatorial_ap_BT_{slug}.xlsx"
