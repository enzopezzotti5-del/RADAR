...
# -*- coding: utf-8 -*-
"""
Pipeline CHESP BT: OCR -> Digitacao -> Filtro.
"""
...
OCR_SCRIPT = LOCAL_DIR / "ocr" / "ocr_chesp_bt.py"
...
def main() -> int:
    ...
    xlsx = OCR_SAIDA_DIR / f"ocr_chesp_BT_{mes}{ano}.xlsx"
