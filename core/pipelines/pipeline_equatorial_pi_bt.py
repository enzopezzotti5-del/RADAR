...
# -*- coding: utf-8 -*-
"""
Pipeline EQUATORIAL PI BT: OCR -> Digitacao -> Filtro.

Uso:
    python pipeline_equatorial_pi_bt.py --mes 05 --ano 2026 --pasta "//servidor/..."
"""
...
OCR_SCRIPT = LOCAL_DIR / "ocr" / "ocr_equatorial_pi_bt.py"
...
PIPELINE_NOME = "EQUATORIAL PI BT"
...
def _xlsx_saida(mes: str, ano: str) -> Path:
    return OCR_SAIDA_DIR / f"ocr_equatorial_pi_BT_{mes}{ano}.xlsx"


def _xlsx_resgate(slug: str) -> Path:
    return OCR_SAIDA_DIR / "_resgates" / f"ocr_equatorial_pi_BT_{slug}.xlsx"
