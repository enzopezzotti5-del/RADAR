...
# -*- coding: utf-8 -*-
"""
Pipeline Light RJ MT: OCR -> Digitacao -> Filtro.

Uso:
    python pipeline_light_mt.py --pasta "\\\\srv\\...\\05.2026\\BT" --mes 05 --ano 2026
    python pipeline_light_mt.py --so-ocr
    python pipeline_light_mt.py --so-digitacao
    python pipeline_light_mt.py --so-filtro
"""
...
OCR_SCRIPT       = LOCAL_DIR / "ocr"              / "ocr_light_rj_mt.py"
...
OCR_SAIDA_DIR  = SERVIDOR / "ARQUIVOS ENZO" / "OCR LIGHT RJ MT"
PIPELINE_SAIDA = SERVIDOR / "ARQUIVOS ENZO" / "LIGHT_MT_pipeline_saida"
...
def _xlsx_saida(mes: str, ano: str) -> Path:
    return OCR_SAIDA_DIR / f"ocr_light_rj_MT_{mes}{ano}.xlsx"


def _xlsx_resgate(slug: str) -> Path:
    return OCR_SAIDA_DIR / "_resgates" / f"ocr_light_rj_MT_{slug}.xlsx"
