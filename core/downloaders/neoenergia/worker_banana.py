...
# -*- coding: utf-8 -*-
"""
Neoenergia Selenium Worker - Banana
- Mantém a estrutura real de índice, extrator e lógica
- Usa pasta temporária exclusiva: downloads_temp_banana
- Não executa main sozinho
- Expõe: run_worker_banana(jobs, shared_lock)
"""
...
TEMP_DOWNLOAD_DIR = BASE_DIR / "downloads_temp_banana"
...
def _inicializar_master() -> None:
    """Chamado apenas dentro de run_worker_banana, nunca no nível de módulo."""
...
def run_worker_banana(jobs, shared_lock, progress_queue=None) -> int:
