...
# -*- coding: utf-8 -*-
"""
Entrada MT/AT do downloader CPFL / RGE.

Isola o ponto de entrada de Media e Alta Tensao para facilitar manutencao e
evolucao, reutilizando a implementacao compartilhada em `cpfl_rge_base.py`.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fluxo MT/AT CPFL/RGE.")
    parser.add_argument(
        "--conta",
    ...
    parser.add_argument("--perfil", choices=["mt"], default="mt")
